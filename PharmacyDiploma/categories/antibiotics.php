...
<div class="main">
    ...
    <div id="container">
        ...
        <div id="main1">
            ...
            <h1>Наш ассортимент в категории "Антибиотик":</h1>
            ...
            <table>
                ...
                $zero_amount = 0;
                $sql = $mysql->query("SELECT DISTINCT * FROM `products`, `dealers` WHERE `products`.`description` = 'Антибиотик' && `products`.`id_dealer` = `dealers`.`id_dealer` && `amount` != '$zero_amount'");
                ...
                while ($row = $sql->fetch_array()) {
                    ...
                    <tr>
                        ...
                        <td><a href="antibiotics.php?page=products&action=add&id=<?php echo $row['id_product']?>" onclick="<?php if(($_SESSION['logged_user']->login == 'NULL')) { print ("<script language=javascript> alert('Для добавления товара в корзину необходимо войти или зарегистироваться!'); </script>"); } ?> "> Добавить в корзину</a> </td>
